/**
 * @file armv8m_scb.h
 * @brief Armv8-M System Control Block register definitions.
 *
 * Secure architecture code uses this layout for VTOR and fault/system-control
 * programming.
 */
...
#define ARMV8M_SCB ((SCB_Type *)ARMV8M_SCB_BASE)
